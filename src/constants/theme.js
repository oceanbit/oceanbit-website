...
export const theme = {
  colors: {
    primary: new DynamicValue(themeColors.primary_light, themeColors.primary_dark),
    error: new DynamicValue(themeColors.error_light, themeColors.error_dark),
    highEmphasis: new DynamicValue(themeColors.highEmphasis_light, themeColors.highEmphasis_dark),
    mediumEmphasis: new DynamicValue(themeColors.mediumEmphasis_light, themeColors.mediumEmphasis_dark),
    lowEmphasis: new DynamicValue(themeColors.lowEmphasis_light, themeColors.lowEmphasis_dark),
    neutralRipple: new DynamicValue(themeColors.neutralRipple_light, themeColors.neutralRipple_dark),
    on_surface_01: new DynamicValue(themeColors.on_surface_01_light, themeColors.on_surface_01_dark),
    on_surface_02: new DynamicValue(themeColors.on_surface_02_light, themeColors.on_surface_02_dark),
    on_surface_03: new DynamicValue(themeColors.on_surface_03_light, themeColors.on_surface_03_dark),
    base: new DynamicValue(themeColors.base_light, themeColors.base_dark),
    primary_ripple: new DynamicValue(themeColors.primary_ripple_light, themeColors.primary_ripple_dark),
  },
};
